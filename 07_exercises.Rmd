...
For your reference you can find the code for the prostacyclin case study from the lecture for chapter 7: [prostacyclin example](./07_prostacyclin_example.Rmd)
...
- Data path:
  ...
  `https://raw.githubusercontent.com/statOmics/PSLS21/data/freshweight_lettuce.txt`
