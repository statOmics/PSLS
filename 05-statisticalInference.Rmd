...
femSamp10 <- data.frame(log2(femSamp10))
femSamp50 <- data.frame(log2(femSamp50))
femSamp100 <- data.frame(log2(femSamp100))
...
res <- rbind(
  calculate_stats(femSamp10),
  calculate_stats(femSamp50),
  calculate_stats(femSamp100)
)
```
